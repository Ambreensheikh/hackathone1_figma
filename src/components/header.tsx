            ...
            <div className='container h-[38px] mx-auto px-4 py-6'>
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <nav className='hidden md:flex items-center gap-8'>
                        ...
                        <Link href={'!#'} className={'text-[16px] leading-[24px] hover:text-gray-500'}>Home</Link>
                        <Link href={'!#'} className={'text-[16px] leading-[24px]'}>Pages</Link>
                        <Link href={'!#'} className={'text-[16px] leading-[24px]'}>Products</Link>
                        <Link href={'!#'} className={'text-[16px] leading-[24px]'}>Blog</Link>
                        <Link href={'!#'} className={'text-[16px] leading-[24px]'}>Shop</Link>
